...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [bindEvent\_](./blockly.bindevent_.md)
...
```typescript
export declare function bindEvent_(node: EventTarget, name: string, thisObject: AnyDuringMigration | null, func: Function): browserEvents.Data;
```
