...
<b>Implements:</b> IASTNodeLocationSvg
...
|  --- | --- | --- | --- |
|  [configureContextMenu](./blockly.workspacesvg.configurecontextmenu.md) |  | AnyDuringMigration | Developers may define this function to add custom menu options to the workspace's context menu or edit the workspace-created set of menu options. |
...
|  [zoomControls\_](./blockly.workspacesvg.zoomcontrols_.md) |  | AnyDuringMigration |  |
