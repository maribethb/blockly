...
string \| number \| [KeyCodes](./blockly.utils_namespace.keycodes_enum.md)
...
_(Optional)_ True to prevent an error when adding a shortcut to a key that is already mapped to a shortcut.
