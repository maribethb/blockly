...
The IFocusableTree to register.


</td></tr>
<tr><td>

rootShouldBeAutoTabbable
...
_(Optional)_ Whether the root of this tree should be added as a top-level page tab stop when it doesn't hold active focus.
