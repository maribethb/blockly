...
<b>Implements:</b> IASTNodeLocationSvg, IBoundedElement, ICopyable, IDraggable
...
|  [customContextMenu?](./blockly.blocksvg.customcontextmenu.md) |  | ((p1: Array&lt;ContextMenuOption \| LegacyContextMenuOption&gt;) =&gt; AnyDuringMigration) \| null | <i>(Optional)</i> |
|  [decompose?](./blockly.blocksvg.decompose.md) |  | ((p1: [Workspace](./blockly.workspace.md)<!-- -->) =&gt; [BlockSvg](./blockly.blocksvg.md)<!-- -->) \| null | <i>(Optional)</i> |
...
|  [saveConnections?](./blockly.blocksvg.saveconnections.md) |  | ((p1: [BlockSvg](./blockly.blocksvg.md)<!-- -->) =&gt; AnyDuringMigration) \| null | <i>(Optional)</i> |
