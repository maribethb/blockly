...
|  [Debug](./blockly.blockrendering.debug.md) | An object that renders rectangles and dots for debugging rendering code. |
...
|  [JaggedEdge](./blockly.blockrendering.jaggededge.md) | An object containing information about the jagged edge of a collapsed block takes up during rendering |
|  [MarkerSvg](./blockly.blockrendering.markersvg.md) | Class for a marker. |
...
|  [RenderInfo](./blockly.blockrendering.renderinfo.md) | An object containing all sizing information needed to draw this block.<!-- -->This measure pass does not propagate changes to the block (although fields may choose to rerender when getSize() is called). However, calling it repeatedly may be expensive. |
