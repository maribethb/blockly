...
```typescript
setOnChange(onchangeFn: (p1: Abstract) => AnyDuringMigration): void;
```
...
|  --- | --- | --- |
|  onchangeFn | (p1: Abstract) =&gt; AnyDuringMigration | The callback to call when the block's workspace changes. |
