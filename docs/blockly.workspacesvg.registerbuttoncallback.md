...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [WorkspaceSvg](./blockly.workspacesvg.md) &gt; [registerButtonCallback](./blockly.workspacesvg.registerbuttoncallback.md)
...
```typescript
registerButtonCallback(key: string, func: (p1: FlyoutButton) => AnyDuringMigration): void;
```
...
|  func | (p1: [FlyoutButton](./blockly.flyoutbutton.md)<!-- -->) =&gt; AnyDuringMigration | The function to call when the given button is clicked. |
