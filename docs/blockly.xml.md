...
|  [textToDom(text)](./blockly.xml.texttodom.md) | Converts an XML string into a DOM structure. |
|  [variablesToDom(variableList)](./blockly.xml.variablestodom.md) | Encode a list of variables as XML. |
|  [workspaceToDom(workspace, opt\_noId)](./blockly.xml.workspacetodom.md) | Encode a block tree as XML. |
