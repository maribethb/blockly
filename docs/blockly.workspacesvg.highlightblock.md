...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [WorkspaceSvg](./blockly.workspacesvg.md) &gt; [highlightBlock](./blockly.workspacesvg.highlightblock.md)
...
|  opt\_state | boolean | <i>(Optional)</i> If undefined, highlight specified block and automatically unhighlight all others. If true or false, manually highlight/unhighlight the specified block. |
