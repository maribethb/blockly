...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [FieldTextInput](./blockly.fieldtextinput.md) &gt; [getEditorText\_](./blockly.fieldtextinput.geteditortext_.md)
...
|  --- | --- | --- |
|  value | any | The value stored in this field.  The text to show on the HTML input. |
