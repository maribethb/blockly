...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [Generator\_2](./blockly.generator_2.md) &gt; [provideFunction\_](./blockly.generator_2.providefunction_.md)

## Generator\_2.provideFunction\_() method
...
|  code | string\[\] \| string | A list of statements or one multi-line code string. Use ' ' for indents (they will be replaced).  The actual name of the new function. This may differ from desiredName if the former has already been taken by the user. |
