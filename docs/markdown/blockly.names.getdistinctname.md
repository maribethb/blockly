...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [Names](./blockly.names.md) &gt; [getDistinctName](./blockly.names.getdistinctname.md)
...
|  type | NameType \| string | The type of entity in Blockly ('VARIABLE', 'PROCEDURE', 'DEVELOPER\_VARIABLE', etc...).  An entity name that is legal in the exported language. |
