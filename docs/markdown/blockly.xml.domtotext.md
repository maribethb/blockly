...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [Xml](./blockly.xml.md) &gt; [domToText](./blockly.xml.domtotext.md)
...
|  --- | --- | --- |
|  dom | Node | A tree of XML nodes.  Text representation.  Blockly.Xml.domToText |
