...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [Block](./blockly.block.md) &gt; [getDescendants](./blockly.block.getdescendants.md)
...
|  --- | --- | --- |
|  ordered | boolean | Sort the list if true.  Flattened array of blocks. |
