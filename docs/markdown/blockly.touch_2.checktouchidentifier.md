...
|  --- | --- | --- |
|  e | Event \| PseudoEvent | Mouse event or touch event.  Whether the identifier on the event matches the current saved identifier.  Blockly.Touch.checkTouchIdentifier |
