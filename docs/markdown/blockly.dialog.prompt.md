...
```typescript
export declare function prompt(message: string, defaultValue: string, callback: (p1: string | null) => any): void;
```
...
|  callback | (p1: string \| null) =&gt; any | The callback for handling user response.  Blockly.dialog.prompt |
