...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [FieldTextInput](./blockly.fieldtextinput.md) &gt; [getValueFromEditorText\_](./blockly.fieldtextinput.getvaluefromeditortext_.md)
...
|  --- | --- | --- |
|  text | string | Text received from the HTML input.  The value to store. |
