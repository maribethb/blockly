...
[Home](./index.md) &gt; [blockly](./blockly.md) &gt; [ShortcutRegistry](./blockly.shortcutregistry.md) &gt; [removeKeyMapping](./blockly.shortcutregistry.removekeymapping.md)
...
|  opt\_quiet | boolean | <i>(Optional)</i> True to not console warn when there is no shortcut to remove.  True if a key mapping was removed, false otherwise. |
