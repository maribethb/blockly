...
using
[`replaceMessageReferences`](/reference/blockly.utils_namespace.parsing_namespace.replacemessagereferences_function),
...
[`Blockly.utils.browserEvents.conditionalBind`](/reference/blockly.utils_namespace.browserevents_namespace.conditionalbind_function)
...
you can use the
[`Blockly.browserEvents.bind`](/reference/blockly.utils_namespace.browserevents_namespace.bind_function)
function.
...
[`setValue`](/reference/blockly.field_class.setvalue_method)
...
override the
[`getText`](/reference/blockly.field_class.gettext_method)function
...
[`getDisplayText_`](/reference/blockly.field_class.getdisplaytext__method)
